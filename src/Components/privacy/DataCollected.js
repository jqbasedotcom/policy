...
const DataCollected = ()=>{
    return <div className="mt-[30px]">
        ...
        <div className="pt-1 pb-1"></div>
        <div>While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you (“<b>Personal Data</b>”). Personally identifiable information may include, but is not limited to:</div>
        <div className="pt-1 pb-1"></div>
        {
        ...
        <div className="pt-1 pb-1"></div>
        <div>We may also collect information that your browser sends whenever you visit our Service or when you access Service by or through any device (“<b>Usage Data</b>”).</div>
        <div className="pt-1 pb-1"></div>
